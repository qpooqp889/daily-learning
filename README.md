...
👉 **線上瀏覽**：https://qpooqp889.github.io/daily-learning/

## 功能
- 🇺🇸 **英文分頁**：單字（詞性、中文意思、劍橋字典）+ 對應句子（中文翻譯）
  - 🔊 **發音大按鈕**：使用瀏覽器內建語音（SpeechSynthesis）朗讀單字/句子，不須外連，手機電腦都能用
  - 🔍 / 🌐 **圖示連結**：單字旁的 🔍 開啟劍橋字典、句子旁的 🌐 開啟 Google 翻譯發音
- 🀄 **國語分頁**：成語（解釋、造句範例）＋ 成語/造句 也有 🔊 發音大按鈕（中文朗讀）
